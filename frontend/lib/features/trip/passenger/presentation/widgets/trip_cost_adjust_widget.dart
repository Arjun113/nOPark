...
class TripCostAdjustState extends State<TripCostAdjust> {
  ...
  void initState() {
    ...
    controller = TextEditingController(text: widget.recommendedBidAUD.toString());
  }
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Text(
              widget.fromCampusCode.toString()
            ),
            Text(
              widget.fromAddressName
            )
        ...
        Center(
          child: Text("Recommended Bid", style: Theme.of(context).textTheme.titleMedium,),
        ),
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
