...
class AddressScroller extends StatefulWidget {
  ...
  const AddressScroller({super.key, required this.addressList});
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                final List<AddressCardData> addresses =
                    widget.addressList.entries
                        .map(
                          (item) => AddressCardData(
                            name: item.name,
                            line1: item.line1,
                            line2: item.line2,
                          ),
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            currAddr.addressNameController.text,
                            style: TextStyle(fontSize: 40),
                          ),
                          SizedBox(height: 12),
                          Text(
                            currAddr.addressLine1Controller.text,
                            style: TextStyle(fontSize: 20),
                          ),
                          SizedBox(height: 5),
                          Text(
                            currAddr.addressLine2Controller.text,
                            style: TextStyle(fontSize: 20),
                          ),
                          const Spacer(),
                          Align(
